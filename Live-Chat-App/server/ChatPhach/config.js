const topic = "5w2pwfeb-default"; // set the correct topic name, especially when you are using CloudKarafka
...
const kafkaConfig = {
  ...
  "sasl.username": "5w2pwfeb",
  "sasl.password": "VicrNRwrt9J83-dgjafnLOoAMQ6rrgyE",
};
